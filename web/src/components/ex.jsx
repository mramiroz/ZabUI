export default function Ex({text, height, textColor, backColor}) {
    if (!height) height = 3
    return (
        <div className="flex items-center p-2 w-full animate-fade-down rounde" style={{height: `${height}rem`, backgroundColor: backColor}}>
